...
static int
dummy_audio_initialize (HistoricHarpsichordPrefs * config)
{
...
static int
dummy_midi_initialize (HistoricHarpsichordPrefs * config)
{
...
static int
dummy_audio_reconfigure (HistoricHarpsichordPrefs * config)
{
  dummy_audio_destroy ();
...
static int
dummy_midi_reconfigure (HistoricHarpsichordPrefs * config)
{
  dummy_midi_destroy ();
